...
public class CreatingCollections {
    ...
    private static void creatingLists() {
        ...
        System.out.println("--> Creating a list the old-" +
                "fashioned way");
        ...
        try {
            ...
            System.out.println("As expected, we can't add" +
                    "items to a list created with Arrays.asList()");
        }
        ...
        try {
            ...
            System.out.println("As expected, we can't add items to a List created with with List.of()");
        }
        try {
